...
function Card({ className, ...props }: React.ComponentProps<'div'>) {
	return (
		<div
			className={cn(
				'bg-card relative w-full max-w-xs dark:bg-transparent',
...
function Header({
	...
	return (
		<div
			className={cn(
				'bg-muted/80 dark:bg-muted/50 relative mb-4 border p-4',
				className,
			)}
			{...props}
		>
...
function Badge({ className, ...props }: React.ComponentProps<'span'>) {
	return (
		<span
			className={cn(
				'border-foreground/20 text-foreground/80 border px-2 py-0.5 text-xs',
				className,
			)}
			{...props}
		/>
